...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210722_alphonsedelcroix_fea1d502ce0c7ea01927_20210722100549_archive.zip';
	const ARCHIVE_SIZE		 = '31474089';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fea1d50-22100549';
    const SECONDARY_PACKAGE_HASH = '4bbf6e7-22100549';
	const VERSION			 = '1.4.2';
